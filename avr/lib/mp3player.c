...
#ifdef _LCD_H_
  uint8_t char_ls[]      = {0x01,0x03,0x0F,0x0F,0x0F,0x0F,0x03,0x01};
  //const uint8_t char_pau[]     = {0x00,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x00};
  uint8_t char_pau[]     = {0x00,0x0A,0x0A,0x0A,0x0A,0x0A,0x00,0x00};    
  //const uint8_t char_ply[]     = {0x08,0x0C,0x0E,0x0F,0x0E,0x0C,0x08,0x00};
  uint8_t char_ply[]     = {0x00,0x08,0x0C,0x0E,0x0C,0x08,0x00,0x00};    
  //const uint8_t char_fwd[]     = {0x00,0x04,0x12,0x09,0x12,0x04,0x00,0x00};
  uint8_t char_fwd[]     = {0x00,0x11,0x09,0x05,0x09,0x11,0x00,0x00};    
  //const uint8_t char_rwd[]     = {0x00,0x04,0x09,0x12,0x09,0x04,0x00,0x00};
  uint8_t char_rwd[]     = {0x00,0x11,0x12,0x14,0x12,0x11,0x00,0x00};    
  uint8_t char_stp[]     = {0x00,0x00,0x0E,0x0E,0x0E,0x00,0x00,0x00};
  uint8_t char_repeat[]  = {0x00,0x00,0x0E,0x11,0x11,0x0E,0x00,0x00};
  uint8_t char_random[]  = {0x00,0x00,0x1B,0x04,0x04,0x1B,0x00,0x00};
#endif
...
{
  uint8_t buffer[10];         // Puffer für Rückgabestring vom Player
...
void serial_interrupt_isr(void)
{
  ...
  err = 0;
  err = mp3_receive_query( (uint8_t*)&command, (uint16_t*)&reply );
