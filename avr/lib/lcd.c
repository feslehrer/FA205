...
// Bibliothek:       lcd.c 
// Controller:       f�r ATmega 
//                   Mit Support f�r I2C-Display mit PCF8574
// Version:          2.0
// erstellt am:      17.2.2015
// letzte �nderung:  30.4.2025
// Autor:            Rahm
...
// m�ssen f�r jeden Controller/Board angepasst werden.
void lcd_waitwhilebusy(void)
{ 
  #ifdef LCD_BUSY
   uint8_t busy;
...
#ifdef LCD_I2C
// 8-Bit Portausgabe (PCF8574) �ber I2C-Bus
...
Beschreibung:    Gibt den Integer n (0...99.999.999) als 8 stelligen
                 ...
                 allign = 0 = _TEXT_ALLIGN_RIGHT_ : F�hrende Nullen werden zu blank.
                 allign = 1 = _TEXT_ALLIGN_LEFT_  : Linksb�ndige Ausgabe
Eingang:         int32, uint8
Ausgang:         ---
==============================================================*/
...
{	
  ...
  while (n<8)                   // Rest von buffer mit blank f�llen
  {
    buffer[n++] = ' ';
  }
...
/////////////////////////////////////////////////////////////////////////////////
// Ab hier sind erg�nzende Funktionen definiert, die nicht Teil der technischen
...
/*************************************************************************
L�schen der Zeilen 1 bis 4 des Displays
